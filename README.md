...
1. Baixe o [arquivo do Servidor](https://github.com/stemcriar/servidor-stem-criar/archive/refs/tags/2.0.zip) em formato `.zip` e descompacte (extraia a pasta) no seu computador.
